            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <p className="text-base md:text-lg lg:text-xl text-white/90">
                  <strong>Last Updated:</strong> Tuesday, December 30, 2025
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">2. Acceptance of Terms</h2>
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">3. Description of Service</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                      Omni is a smart credit card rewards optimization service that:
                    </p>
                    <ul className="list-none space-y-3 text-base md:text-lg lg:text-xl text-white/90 ml-4">
                    ...
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mt-4">
                      We reserve the right to modify, suspend, or discontinue any aspect of the Service at any time, with or without notice.
                    </p>
                  </div>

                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">4. User Accounts</h2>
                    <h3 className="text-xl md:text-2xl font-semibold text-white mt-6 mb-3">Account Creation</h3>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl md:text-2xl font-semibold text-white mt-6 mb-3">Account Security</h3>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">5. Use of Service</h2>
                    <h3 className="text-xl md:text-2xl font-semibold text-white mt-6 mb-3">Permitted Use</h3>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">6. Financial Information and Third-Party Services</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                    ...
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mt-4">
                      <strong>Important:</strong> Omni provides recommendations and information for informational purposes only. We do not provide financial, investment, or legal advice. You should consult with qualified professionals before making financial decisions.
                    </p>
                  </div>

                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">7. Intellectual Property</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">8. Disclaimer of Warranties</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                    ...
                    <ul className="list-none space-y-3 text-base md:text-lg lg:text-xl text-white/90 ml-4 mt-4">
                      <li className="flex items-start gap-3">
                        <span className="text-purple-300 mt-1">•</span>
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">9. Limitation of Liability</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">10. Indemnification</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">11. Termination</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">12. Changes to Terms</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">13. Governing Law</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">14. Severability</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-semibold text-white mb-4">15. Contact Us</h2>
                    <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed mb-4">
